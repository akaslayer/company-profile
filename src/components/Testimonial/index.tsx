  ...
  return (
    <div className='bg-grey p-10 grid  gap-10 justify-center md:grid-cols-2 bg-slate-200 items-center md:p-20'>
      <div className="grid-item flex flex-col gap-8 font-DM-Sans">
        ...
        <p className='text-lg'>Simplified IT has transformed our operations with their advanced solutions. Their chatbot enhances customer interaction, OCR streamlines document processing, data management turns our data into a strategic asset, and RPA automates routine tasks, boosting productivity.</p>
        <Link href="/teams" className="relative rounded-full py-3 px-6 overflow-hidden group bg-gradient-to-r from-cyan-500 to-blue-500 w-fit hover:bg-gradient-to-r hover:from-blue-500 hover:to-cyan-400 text-white transition-all ease-out duration-300 md:px-10">
