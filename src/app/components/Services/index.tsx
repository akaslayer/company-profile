...
const Services = () => {
  return (
    <div id='services'>
      <div className='px-20 flex flex-col justify-center mt-20 gap-2 py-20'>
        <div className="title bg-blue-400 text-center m-auto px-6 py-2 rounded-full font-bold text-white">
