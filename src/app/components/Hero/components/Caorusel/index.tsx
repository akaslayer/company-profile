  ...
  return (
    <div className='relative transition-opacity duration-500 ease-in-out w-full ' style={{ opacity: isTransitioning ? 0 : 1 }}>
      ...
      <div className="absolute flex flex-col top-1/2 -translate-y-1/2 left-20 gap-2  w-fit md:gap-8 md:left-36 md:top-[40%]">
        <h5 className='bg-white w-fit text-lg rounded-full shadow-lg shadow-blue-200 py-2 px-4 font-bold text-blue-700  md:text-2xl'>We are IT service agency ~</h5>
        <h1 className='text-white text-2xl w-[90%] font-bold   shadow-blue-200 md:text-6xl md:w-3/4' style={{ textShadow: '1px 0px #90CAF9' }}>A LEADING PROFESSIONAL TECH COMPANY</h1>
        <h5 className='text-white w-3/4 font-semibold break-all text-lg md:text-2xl' style={{ textShadow: '1px 0px #90CAF9' }}>We Provide A Cutting Edge Solution For What You Need</h5>
