    ...
    <div className='overflow-hidden'>
      <div className='relative transition-opacity duration-500 ease-in-out w-full' style={{ opacity: isTransitioning ? 0 : 1 }}>
        <div className='flex' style={{ opacity: isTransitioning ? 0 : 1 }}>
          <Image loading="eager" src={HeroData[currentIndex]} alt='hero' width={1280} height={720}
        ...
        <div className="absolute flex flex-col top-1/2 -translate-y-1/2 left-20 gap-2  w-fit md:gap-8 md:left-36 md:top-[40%]">
          ...
          <h2 className='text-white text-xl w-[90%] font-bold   shadow-blue-200 md:text-6xl md:w-3/4' style={{ textShadow: '1px 0px #90CAF9' }}>Innovating Your Future with Intelligent IT Solutions</h2>
          <h3 className='text-white w-3/4 font-semibold break-all text-md md:text-2xl' style={{ textShadow: '1px 0px #90CAF9' }}>Providing cutting-edge solutions tailored to your needs</h3>
